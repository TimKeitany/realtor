...
/*
* When use chooses a billing cycle
*/
$("body").on("change","input[name=cycle]", function(){
    ...
    $(".checkout-btn").each(function() {
        var originaldata = $(this).attr("data-original");
        $(this).attr("data", originaldata+cycle);
    })

});

/*
 * When user clicks start plan
 */
$("body").on("click", ".checkout-proceed", function (event) {
    event.preventDefault();
...
NioApp.calculatetotal = function(items) {
    ...
    var grandtotal = 0, taxtotal = 0, subtotal = 0, rowsubtotal = 0, rowtaxtotal = 0, grandtotal = 0, taxtotal = 0;
...
$(".send-email").click(function(event){
    ...
    $("#sendemail").find("input[name=email]").val(email);
